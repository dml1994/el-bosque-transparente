...
export const metadata = {
  ...
  description:
    "Retribuciones anuales del alcalde y concejales del Ayuntamiento de El Bosque. Datos oficiales del Ministerio de Hacienda (ISPA).",
  ...
  openGraph: {
    ...
    description: "Retribuciones del alcalde y concejales de El Bosque. Fuente: ISPA (Ministerio de Hacienda).",
